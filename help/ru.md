...
"PO-Revision-Date: 2024-09-24 20:45+1000\n"
...
"цветовых схем, что позволяет изменять внешний вид главной текстовой области."
...
msgstr "Для светлого и тёмного вариантов оформления"
...
msgstr ""
"Фактически существует два варианта цветовых схем: одна цветовая схема для "
"использования светлой темы в приложении, и другая цветовая схема для "
"применения тёмной темы. Диалоговое окно <gui>Параметры</gui> позволяет "
"выбрать один из этих вариантов."

#. (itstool) path: section/title
#: C/gedit-change-color-scheme.page:42
msgid "About unsupported color schemes"
msgstr "О неподдерживаемых цветовых схемах"
...
msgstr ""
"Поддержка некоторых цветовых схем для используемого варианта темы (светлая "
"или тёмная) может быть не предусмотрена. В этом случае цветовая схема не "
"может быть выбрана и помечается как неподдерживаемая."
...
msgstr ""
"Это происходит, когда цветовая схема наследует некоторые цвета из темы, и "
"предполагается, что она может использоваться только либо для светлой, либо "
"для тёмной темы. Если бы была возможность применить такую цветовую схему при "
"использовании неправильной темы, то оказалось бы, что цветовая схема "
"содержит ошибки и часть текста непригодна для чтения."
...
msgstr ""
"Вы также можете использовать цветовые схемы, созданные другими "
"пользователями, или создавать и использовать свои собственные. См. <link "
"href=\"https://gedit-technology.github.io/developer-docs/extra/libgedit-"
"gtksourceview/style-schemes.html\">libgedit-gtksourceview documentation</"
"link>."

#. (itstool) path: info/desc
#: C/gedit-close-file.page:7
msgid "Exit from the file you are using."
msgstr "Завершение работы с файлом."
...
"сторонних модулей находится <link href=\"https://gitlab.gnome.org/World/"
"gedit/gedit/-/blob/master/plugins/third-party-plugins.md\">здесь</link>."
...
"preferred option."
msgstr ""
"Слова «wonderful» и «amazing» могут быть оставлены или удалены в зависимости "
"от вашего выбора. Для этого нажмите <key>Tab</key>, чтобы выбрать между "
"словами «wonderful» и «amazing», и нажмите <key>Del</key>, чтобы удалить "
...
"default text size."
msgstr ""
"Модуль «Размер текста» позволяет в <app>gedit</app> временно изменять размер "
"текста для улучшения читаемости, не изменяя при этом настройку размера "
"текста в самом приложении."
...
msgstr ""
"Для включения модуля <gui style=\"menuitem\">Размер текста</gui> выберите "
"его из списка."

#. (itstool) path: section/title
#: C/gedit-plugins-text-size.page:34
msgid "Use the <app>Text Size</app> plugin"
msgstr "Использование модуля <app>Размер текста</app>"
...
msgstr ""
"После включения модуля в <app>gedit</app> выполните любое из доступных "
"действий для изменения размер текста:"
...
msgstr ""
"Для <em>сброса</em> размера текста до исходного, нажмите <keyseq><key>Ctrl</"
...
msgstr ""
"Для более общей информации обратитесь к <link href=\"help:gnome-help/"
"printing\">справке по печати для GNOME</link>."

#. (itstool) path: section/title
#: C/gedit-printing.page:23
msgid "Print Dialog"
msgstr "Диалоговое окно печати"

#. (itstool) path: section/p
#: C/gedit-printing.page:24
msgid "To open the <gui>Print</gui> dialog, either:"
msgstr "Чтобы открыть диалоговое окно <gui>Печать</gui>:"
...
msgstr ""
"Нажмите <guiseq><gui style=\"menu\">Кнопку меню</gui> <gui "
"style=\"menuitem\">значок печати</gui></guiseq>."

#. (itstool) path: item/p
#: C/gedit-printing.page:32
msgid "Or press <keyseq><key>Ctrl</key><key>P</key></keyseq>."
msgstr "Или нажмите <keyseq><key>Ctrl</key><key>P</key></keyseq>."
...
msgstr ""
"В диалоговом окне <gui>Печать</gui> нажмите на кнопку <gui "
"style=\"button\">Образец</gui>."

#. (itstool) path: section/title
#: C/gedit-printing.page:51
msgid "Text Editor Settings Tab"
msgstr "Вкладка настроек «Текстовый редактор»"
...
msgstr ""
"Внутри диалогового окна <gui>Печать</gui> есть вкладка <gui>Текстовый "
"редактор</gui> для настройки способа печати текста."
...
msgstr ""
"Там вы можете настроить печать номеров строк, перенос текста, шрифты, "
"заголовки страниц и многое другое."
...
#~ "<keyseq><key>Ctrl</key><key>Alt</key><key>O</key></keyseq>, или выбрав "
#~ "<gui style=\"menuitem\">Быстрое открытие…</gui>."
...
#~ "in <app>Files</app>"
#~ msgstr ""
#~ "Последние документы, которые также показаны в папке <file>Недавние</file> "
#~ "в программе <app>Файлы</app>"
...
#~ msgstr ""
#~ "Модуль <app>Быстрое открытие</app> отображает файлы из любого "
#~ "вышеуказанного места, независимо от того, открывали их ранее или нет."
...
#~ msgstr ""
#~ "Снимите флажок рядом с надписью: «Использовать системный моноширинный "
#~ "шрифт»."
...
#~ "обратном порядке. Чтобы изменить порядок:"
...
#~ "gui>."
#~ msgstr ""
#~ "На вкладке <gui>Общие</gui>, в группе параметров <gui "
#~ "style=\"group\">Копии</gui>, отметьте параметр <gui "
#~ "style=\"checkbox\">Упорядочить</gui>."
...
#~ msgstr ""
#~ "Для печати с помощью <app>gedit</app> требуется подключённый и "
...
#~ msgstr ""
#~ "Предварительный просмотр документа откроется в той же вкладке, что и "
#~ "файл. По предварительному просмотру можно перемещаться с помощью кнопок "
#~ "навигации и панели инструментов в верхней части вкладки предварительного "
#~ "просмотра документа. Чтобы закрыть предварительный просмотр и вернуться к "
#~ "документу, нажмите кнопку <gui style=\"button\">Закрыть просмотр печати</"
#~ "gui>."
...
#~ msgstr ""
#~ "Дополнительно, на вкладке <gui style=\"tab\">Параметры страницы</gui>, "
#~ "можно выбрать параметры <gui style=\"group\">Размещения</gui> и <gui "
...
#~ msgstr ""
#~ "Также можно использовать <app>gedit</app> для печати документа в файл. "
#~ "Чтобы распечатать документ в файл:"
...
#~ msgstr ""
#~ "Можно выборочно печатать лишь некоторые страницы документа. Например, "
#~ "если в текстовое поле Страницы ввести «1,3,5-7,9», то будут распечатаны "
#~ "страницы 1, 3, 5, 6, 7 и 9. Чтобы выборочно напечатать страницы:"
...
#~ "которые нужно распечатать. Для указания диапазона страниц используйте "
#~ "дефис."
